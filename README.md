# DevMentor Brasil - Projeto Clima
...
Seu desafio é desenvolver um projeto previsão clima onde o usuário pode digitar o nome de uma cidade e deverá aparecer a temperatura atual dessa cidade, descrição de como está o tempo.
...
- Usuário pode acessar o site e digitar o nome de uma cidade e quando clicar em pesquisar deverá fazer uma requisição na API e mostrar na tela os dados como temperatura e descrição como está o tempo.
- Se o usuário tentar buscar uma cidade que não foi encontrada deverá mostrar um alerta com a mensagem que não foi possível encontrar a cidade.
